#
#  Be sure to run `pod spec lint WebRTCDatachannel.podspec' to ensure this is a
...
#   spec.platform     = :ios, "10.0"
  ...
  spec.source       = { :git => "https://github.com/cdnbye/WebRTCDatachannel.git", :tag => "#{spec.version}" }
